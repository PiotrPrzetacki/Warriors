...
public class ArenaSelectionPanel extends JPanel {
    ...
    private final ArenaSelectionStackPanel arenaSelectionStackPanel;
    ...
    public ArenaSelectionPanel(GameSettings gameSettingsPanel){
        ...
        List<Arena> availableArenas = new ArrayList<>(Arrays.asList(
                new Jungle(),
                new Desert(),
                new Hell(),
                new Winter()
        ...
        JLabel title = new HeaderLabel("Select arena", 1);
        ...
        JButton playBtn = new SecondaryButton("Play!", new Font(Constants.defaultFontFamily, Font.BOLD, 22), new int[]{7, 15, 7, 15});
