...
public class Archer  extends CharacterClass {
    public Archer(String name, int x, int y, int leftKey, int rightKey, int upKey, int downKey, int leftAttackKey, int rightAttackKey) {
        ...
        /*this.setX(300);
        this.setY(300);*/
        this.uploadImage("assets/images/characters/ArcherBaseImage.png", "assets/images/characters/ArcherAttackLeftImage.png", "assets/images/characters/ArcherAttackRightImage.png");
